...
import { activities, leads } from '../src/db/schema';
import { eq } from 'drizzle-orm';

const prospects = [
  { name: 'Mercatto Pizzaria', username: 'pizzaria_mercatto', city: 'Maceió', category: 'Restaurante' },
  { name: 'Mercatto Restaurante', username: 'mercattopizzaria', city: 'Maceió', category: 'Restaurante' },
